...
/**
	...
	int num_words: an integer (passed by value) that is set by the function
		that equals the number of passwords in the file

	char** usernames: an array of strings (char*) (passed by value) that when the function
		is completed will contain each the usernames in the file

	char** hashes: an array of strings (char*) (passed by value) that when the function
		is completed will contain each the crypted passwords of each user in the file

	char** fullnames: an array of strings (char*) (passed by value) that when the function
